...
export default function Projects() {
  return (
    <div className="page-container">
      <div className="skinny-body-container martop bmarbot">
        <h1 id="projects">Projects</h1>
        <p>Our vision is to to preserve and make accessible significant historical content created by public media,
        and to coordinate a national effort to save at-risk public media before its content is lost to posterity. We&#39;re fulfilling our vision through several exciting grant projects.</p>
        <h3 id="the-american-archive-of-public-broadcasting-from-repository-to-resource">The American Archive of Public Broadcasting: From Repository to Resource</h3>
        ...
        <h3 id="the-public-broadcasting-preservation-fellowship">The Public Broadcasting Preservation Fellowship</h3>
        ...
        <h3 id="the-american-archive-of-public-broadcasting">The American Archive of Public Broadcasting</h3>
        ...
        <h3 id="pbcore-development-and-training-project">PBCore Development and Training Project</h3>
        ...
        <h3 id="pbs-newshour-digitization-project">PBS NewsHour Digitization Project</h3>
        ...
        including <em>The Robert MacNeil Report</em>, <em>The MacNeil/Lehrer Report</em>, <em>The MacNeil/Lehrer NewsHour</em>, and <em>The NewsHour with Jim Lehrer</em>. The project is generously funded by CLIR.
        <a href="/about-the-american-archive/projects/newshour">Read more about the PBS NewsHour Digitization Project</a>.</p>
        <h3 id="improving-access-to-time-based-media-through-crowdsourcing-and-machine-learning-project">Improving Access to Time-Based Media through Crowdsourcing and Machine Learning Project</h3>
        ...
        <h3 id="aapb-national-digital-stewardship-residency-project">AAPB National Digital Stewardship Residency Project</h3>
        ...
        <h3 id="national-educational-television-net-collection-catalog-project">National Educational Television (NET) Collection Catalog Project</h3>
        ...
        <h3 id="american-archive-permanent-entity-grant">American Archive Permanent Entity Grant</h3>
