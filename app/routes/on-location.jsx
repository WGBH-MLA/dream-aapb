    ...
    <div className="skinny-body-container marbot">
      ...
      <div className="marbot">
        <ul className="blank-list">
          ...
          <li>8 am to 5 pm, Monday through Friday</li>
          <li>WGBH Educational Foundation</li>
          <li>GBH Archives</li>
          <li>One Guest Street</li>
          <li>Boston, MA 02135</li>
        </ul>

        <img style={{ float: "left" }} src='https://s3.amazonaws.com/americanarchive.org/on-location/wgbh-exterior.jpg' />
      </div>
      <div className="marbot">
      ...
      <div className="marbot">
        ...
        <img style={{ float: "left" }} src='https://s3.amazonaws.com/americanarchive.org/on-location/library-exterior.jpg' />
      </div>
      ...
      <div className="marbot">
        <ul className="blank-list">
          ...
          <li>101 Independence Ave. SE</li>
          <li>James Madison Building, LM 113</li>
          <li>Recorded Sound Research Center</li>
          <li>Performing Arts Reading Room</li>
          <li>Washington, DC 20540-4690</li>
        </ul>

        <img style={{ float: "left" }} src='https://s3.amazonaws.com/americanarchive.org/on-location/wgbh-exterior.jpg' />
      </div>

      <h4>Who Can Listen:</h4>
      <div className="marbot">
      ...
      <div className="marbot">
        Offsite researchers may begin their search by using the <a href="https://www.loc.gov/rr/record/">Recorded Sound Research Center site</a>, Library of Congress Online Catalog, or Sound Online Inventory and Catalog (SONIC). If unable to find a recording in the catalogs, please contact our reference staff by emailing rsrc@loc.gov or calling (202) 707-7833.
      </div>

      <h3>Moving Image Section</h3>
      <div className="marbot">
        <ul className="blank-list">
          <li>Hours and Location:</li>
          <li>8:30 am to 5:00 pm, Monday through Friday</li>
          <li>Library of Congress</li>
          <li>101 Independence Ave. SE</li>
          <li>James Madison Building, LM 336</li>
          <li>Moving Image Research Center</li>
          <li>Washington, D.C. 20540-4690</li>
        </ul>
      </div>
      ...
      <h4>Submitting Viewing Requests:</h4>
      <div className="marbot">
        ...
        Offsite researchers should begin their search by using the <a href="https://www.loc.gov/rr/mopic/">Moving Image Research Center site</a> or Library of Congress Online Catalog. For materials other than those in the American Archive Collection, please limit your request to forty titles.
      ...
      <h4>Reader Identification Card:</h4>
      <div className="marbot">
