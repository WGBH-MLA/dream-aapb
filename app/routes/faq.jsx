  ...
  return (
    <div className="page-container">
      <div className="skinny-body-container marbot">
        ...
        <h3>What is available on the AAPB website?</h3>
        <p className="marbot">The AAPB website provides three layers of searching and browsing:</p>
        <ul className="marbot">
          <li>Users can access the AAPB Online Reading Room, which provides online access to some of the digitized collection for private research, educational and informational purposes.</li>
          <li>Users can search metadata records for all digitized items, including content that is available in the Online Reading Room and content that is only available for viewing and listening on location at GBH and the Library of Congress.</li>
          <li>Users can search the 2.5 million metadata records that document public radio and television assets existing at more than 120 public media stations and archives across the country. Most of these assets have not been digitized.</li>
        </ul>
        <p className="marbot">The AAPB has also curated <a href="/exhibits">exhibits</a> that feature content on topics of historical significance and <a href="/collections">special collections</a> highlighting notable content from the archive.</p>

        <h3>I'm interested in accessing the entire digitized collection at GBH or the Library of Congress, and I want to begin my search before traveling to one of the research locations. How can I tell if something was digitized in the AAPB?</h3>
        <p className="marbot">
          After you conduct a search on the AAPB website, click the "All Digitized" link below the "Search Records" bar above the list of search results. This will display records for all items that are digitized, including those only available at GBH and the Library of Congress.
        </p>

        <h3>I want to conduct research using the entire AAPB collection. How can I do so?</h3>
        <p className="marbot">
          The entire AAPB collection is available for research at GBH in Boston and the Library of Congress in Washington, D.C. More information about on-location research policies and scheduling an appointment is available <a href="/on-location">here</a>.
        </p>

        <h3>Will more content be available in the Online Reading Room than what is available now?</h3>
        <p className="marbot">
