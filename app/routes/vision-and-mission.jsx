...
export default function Contribute() {
  return (
    <div className="skinny-body-container">
      ...
      <SummaryBox title="Vision Statement" text="The American Archive of Public Broadcasting seeks to preserve and make accessible
...
national effort to save at-risk public media before its content is lost to posterity." />
      ...
      <BigLink url="https://www.mellon.org/grant-story/reel-talk-saving-americas-public-media" title="Reel Talk: Saving America’s Public Media Matters More Than You May Know" text="If these materials remain undigitized and are simply left to time, historians and archivists won’t be the only ones who will lose." />
