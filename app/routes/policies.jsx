...
export default function Terms() {
  return (
    <div className="page-container">
      ...
      <div className="skinny-body-container marbot">
     <p>Thank you for visiting americanarchive.org (the “Site”). We know you don’t want
...
financial transactions and transmit your personal data with full confidence.</p>

<p>The privacy policy set forth here refers solely to americanarchive.org. Please
...
<p>We will not collect personally identifiable information from you, other than
what you supply to us on a voluntary basis upon request.</p>

<h4 id="registration-for-our-website">Registration for our website:</h4>

<p>Anyone can view our site, however some portions of the Site require a free
...
you are agreeing to the conditions of our <a href="/legal/tou">Terms of Use</a>.</p>

<h4 id="forums-feedback-and-content-submissions">Forums, Feedback and Content Submissions:</h4>

<p>On certain pages within the Site you can submit content to be published, make
...
users regarding their submissions in certain circumstances.</p>

<h4 id="support-of-aapb">Support of AAPB</h4>

<p>On certain pages within the Site we may now or in the future offer visitors the
...
email address, billing address, and credit card information.</p>
...
<p>On certain pages within the Site you can submit information about other people.
For example, you may submit a person’s name and email address to recommend a
collection. This information will only be used for your intended purpose.</p>

<h4 id="email-and-email-newsletters">Email and Email Newsletters:</h4>

<p>On occasion, we may collect personal information from users in connection with
...
Privacy Policy of that third party service provider will apply.</p>
...
indicated at the time of collection.</p>

<h3 id="b-non-personally-identifiable-information">B. Non-personally Identifiable Information</h3>

<p>In addition to information that you provide to us, we (again, this is GBH and
...
<p>For example, we may collect your IP address, browser information and reference
...
from what we receive via a cookie and your browser.</p>

<p>You can set your browser preferences to refuse cookies or to alert you when
...
<p>Neither GBH, nor our third-party vendors and/or service providers acting on
...
NPR, PBS, and other public broadcasting stations.</p>

<p>In terms of our own use of information, we may use your personally identifiable
...
marketing promotional purposes as further described in this policy.</p>
...
<p>As mentioned, in certain cases, we may contract with other companies or use
...
services to process the donation.</p>

<p>We will not sell, exchange, or lend email addresses to any non-affiliated third
...
anyone’s rights, property or safety.</p>

<p>On certain pages, we may now or in the future, offer visitors the opportunity
...
and on mobile platforms.</p>

<p>We reserve the right to send you email relating to your account status. This
...
your participation in those activities.</p>

<p>We may offer an email listserv via third party services. We will always provide
...
<p>GBH, with the assistance from time to time of its third party service vendors,
...
that could be used to identify those users.</p>

<h2 id="3-security-of-information"><a name="security">3. SECURITY OF INFORMATION</a></h2>

<p>GBH has in place what we believe to be appropriate physical, electronic, and
...
<p>Our Site is a general audience site and does not knowingly collect or store
personally identifiable information about children under the age of 13.</p>

<h2 id="5-corrections-to-personal-data-opting-out"><a name="corrections">5. CORRECTIONS TO PERSONAL DATA; OPTING OUT</a></h2>

<p>Please Contact Us to a) correct or update any personal information in the GBH
...
information entirely because of backups and records of deletions.</p>
...
<p>By using this Site, you signify your agreement to the terms and conditions of
...
concerns, please contact us.</p>

<h2 id="7-changes-to-this-privacy-policy"><a name="changes">7. CHANGES TO THIS PRIVACY POLICY</a></h2>

<p>Whenever this Privacy Policy for our Site changes, we will post the changes to
...
page of our Site or sending you an email if we have your email address.</p>

<h2 id="notice-to-parents-and-legal-guardians"><a name="notice">NOTICE TO PARENTS AND LEGAL GUARDIANS</a></h2>

<p>It is our goal to provide service on our site while maintaining our strong
...
identified themselves as younger than 18.</p>

<h2 id="discussion-and-comment-policy"><a name="discussion">DISCUSSION AND COMMENT POLICY</a></h2>

<p>This is the discussion policy for users of americanarchive.org’s
...
the following guidelines may have their comments removed or blocked.</p>

<p>Our guidelines are intended to facilitate a sense connection and sharing within
the online community of this Site. You can contribute to and be part of our
community by participating on americanarchive.org with these guidelines in mind:</p>
...
illegal in any way will be removed and the poster will be blocked.</li>
<li>    Post clear, concise comments (posts longer than 200 words tend to be
...
version of shouting.</li>
<li>    Stay with the topic at hand. Keeping your posts focused contributes to
the best possible discussion.</li>
<li>    Write your own posts. A link or quote from another source can be a
...
conversation lively and focused by posting only one link per comment.</li>
<li>    Promote the discussion, rather than your own interests. the online
...
judgment and we’ll use ours.</li>
</ol>
